...
public class MessagingService extends FirebaseMessagingService {
    ...
    public void buildLocalNotification(RemoteMessage remoteMessage) throws JSONException {
        if(remoteMessage.getData() == null){
            return;
        }
    ...
    public void handleIntent(Intent intent) {
        ...
        String customNotification = "{\"id\":\"1516216566424\",\"link\":\"" + intent.getExtras().getString("link") + "\",\"show_in_foreground\":true,\"group\":\"group\",\"click_action\":\"ACTION.OPEN_LINK\",\"auto_cancel\":true,\"body\":\"" + intent.getExtras().getString("body") + "\",\"ongoing\":true,\"wake_screen\":true,\"sound\":\"default\",\"priority\":\"high\",\"badge\":1,\"title\":\"SCIS\",\"vibrate\":300.0,\"number\":1.0,\"large_icon\":\"ic_launcher\",\"local_notification\":true,\"icon\":\"ic_launcher\",\"icon\":\"ic_stat_logo\"}";
